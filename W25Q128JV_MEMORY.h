...
#ifndef INC_W25Q128JV_MEMORY_H_
#define INC_W25Q128JV_MEMORY_H_
#endif /* INC_W25Q128JV_MEMORY_H_ */

#ifndef SPI_Timeout
#define SPI_Timeout 10
#endif

class W25Q128JV_MEMORY {
	public:
...
#pragma pack(pop)
     ...
     */
		W25Q128JV_MEMORY(SPI_HandleTypeDef *_spi,
		...
		W25Q128JV_MEMORY::TelemetryData Data_Bundle[4];
...
//{
//    SPI_HandleTypeDef *spi;
//} W25Q128JV_MEMORY_Handler;
//
//
//void W25Q128JV_MEMORY_DeviceID(SPI_HandleTypeDef *spi);
//uint8_t W25Q128JV_MEMORY_Read_Status_Reg1(SPI_HandleTypeDef *spi);
//void W25Q128JV_MEMORY_Chip_Erase(SPI_HandleTypeDef *spi);
//
//void W25Q128JV_MEMORY_Chip_Write(SPI_HandleTypeDef *spi,uint32_t *address);
//void W25Q128JV_MEMORY_Chip_Read (SPI_HandleTypeDef *spi,uint32_t *address);
